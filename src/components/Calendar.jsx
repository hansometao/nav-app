  ...
  return (
    <div className="widget calendar-widget">
      ...
      <div className="lunar-header">
        <div className="lunar-info-main">
          <span className="lunar-era">{yearInfo.tianGan}{yearInfo.diZhi}年</span>
          <span className="lunar-zodiac">{yearInfo.shengXiao}年</span>
        </div>
        {selectedDate ? (
          <div className="lunar-info-detail">
            <span className="lunar-date">
              {selectedLunarInfo.isLeap ? '闰' : ''}{selectedLunarInfo.monthName}{selectedLunarInfo.dayName}
            </span>
            {selectedLunarInfo.currentJieQi && (
              <span className="jieqi-badge">{selectedLunarInfo.currentJieQi}</span>
            )}
          </div>
        ) : (
          <div className="lunar-info-detail">
            <span className="lunar-date">
              今日 {selectedLunarInfo.isLeap ? '闰' : ''}{selectedLunarInfo.monthName}{selectedLunarInfo.dayName}
            </span>
            {selectedLunarInfo.currentJieQi && (
              <span className="jieqi-badge">{selectedLunarInfo.currentJieQi}</span>
            )}
      ...
      {viewMode === 'month' && (
        <>
          <div className="calendar-nav">
            <button onClick={prevYear} className="btn-icon" title="上一年">
              <Icon name="chevronLeft" size={14} />
              <Icon name="chevronLeft" size={14} />
            </button>
            <button onClick={prevMonth} className="btn-icon" title="上月">
              <Icon name="chevronLeft" size={16} />
            </button>
            <span className="calendar-title">{year}年 {monthNames[month]}</span>
            <button onClick={nextMonth} className="btn-icon" title="下月">
              <Icon name="chevronRight" size={16} />
            </button>
            <button onClick={nextYear} className="btn-icon" title="下一年">
